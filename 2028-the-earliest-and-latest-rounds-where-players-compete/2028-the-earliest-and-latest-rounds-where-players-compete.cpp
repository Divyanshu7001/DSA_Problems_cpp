// Position matters very much..really important because of the rules
// After each round..remaining players=(n+1)/2
// Position of both best players depend on
//  players on left of first player
// players between both the players
//Approach : (Recursion)
//T.C : T(n) = n^2 * T(n/2)
