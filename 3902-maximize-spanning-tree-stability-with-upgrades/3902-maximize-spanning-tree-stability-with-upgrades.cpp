// Sub topics
// Binary search on answer where the answer is stability here
// then write a check function accordingly
// DSU used for checking if two given nodes are connected
class DSU {
public:
